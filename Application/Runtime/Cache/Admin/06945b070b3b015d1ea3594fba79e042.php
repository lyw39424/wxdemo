...
<input type="hidden" id="id" name="id" value="<?php echo ($detail["id"]); ?>">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="wxid">
					<option value=<?php echo ($names["id"]); ?>><?php echo ($names["wxname"]); ?></option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  value="<?php echo ($detail["name"]); ?>" placeholder="" id="roleName" name="roleName" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><dl class="permission-list">
                    <dt>
                        <label>
                            <input type="checkbox" value="<?php echo ($vo["menu_cate"]); ?>" name="Character[<?php echo ($k); ?>]" id="Character[<?php echo ($k); ?>]" <?php echo ($vo["checked"]); ?>>
                ...
                <dd>
                    ...
                    <dt>
                        <label class="">
                            <input type="checkbox" value="<?php echo ($twocode["menu_tite"]); ?>+<?php echo ($twocode["titel_code"]); ?>" name="Charactero[<?php echo ($ke); ?>][<?php echo ($k); ?>]" id="Charactero[<?php echo ($ke); ?>][<?php echo ($k); ?>]" <?php echo ($twocode["checked"]); ?>>
                    ...
                    <?php if(is_array($twocode["buttons"])): $kes = 0; $__LIST__ = $twocode["buttons"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$buttons): $mod = ($kes % 2 );++$kes;?><dd>
                        <label class="">
                            <input type="checkbox" value="<?php echo ($buttons["menu_code"]); ?>" name="Charactert[<?php echo ($kes); ?>][<?php echo ($ke); ?>][<?php echo ($k); ?>]" id="Charactert[<?php echo ($kes); ?>][<?php echo ($ke); ?>][<?php echo ($k); ?>]" <?php echo ($buttons["checked"]); ?>>
