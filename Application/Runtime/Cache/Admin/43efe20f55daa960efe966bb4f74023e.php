...
<html>
<head>
	<script src="/wxdemo/Public/admin/jquery-2.0.3.min.js" ></script>
...
<script type="text/javascript">
	$(function() {
		$('#file_upload').uploadify({
			...
			'uploader' : '<?php echo U("AdminUser/img");?>',
			'buttonText' : '头像上传',
...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('AdminUser/add');?>" method="post" id="form-admin-add">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			...
			<select class="select" name="adminRole" size="1">
				<?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			</span> </div>
	</div>
	<div class="row cl">
