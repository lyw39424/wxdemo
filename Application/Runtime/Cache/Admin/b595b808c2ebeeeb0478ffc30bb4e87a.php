...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">微信后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v0.1</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
				...
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="#">切换账户</a></li>
							<li><a href="/wxdemo/Admin/Login/login">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="/wxdemo/Admin/Wechat/index" data-title="公众号管理" href="javascript:void(0)">公众号管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="/wxdemo/Admin/Role/index" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="/wxdemo/Admin/Menue/index" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="/wxdemo/Admin/AdminUser/index" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
			...
			<dd>
				<ul>
				<li><a _href="/wxdemo/Admin/Baob/index" data-title="3D柱状图" href="javascript:void(0)">3D柱状图</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a _href="/wxdemo/Admin/SysTems/sysbase" data-title="系统设置" href="javascript:void(0)">系统设置</a></li>
					<li><a _href="/wxdemo/Admin/SysTems/syslog" data-title="系统日志" href="javascript:void(0)">系统日志</a></li>
				</ul>
			</dd>
		</dl>
	</div>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="/wxdemo/admin/WxOthor/welcome">我的桌面</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="/wxdemo/admin/WxOthor/welcome"></iframe>
		</div>
	</div>
</section>
