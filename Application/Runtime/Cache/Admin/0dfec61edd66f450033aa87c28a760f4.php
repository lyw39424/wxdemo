    ...
    <div class="form form-horizontal" >
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img id="verifyImg" src="/wxdemo/Admin/Login/verify" onClick="changeVerify()" height="40" width="150" title="点击刷新验证码" /></div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
...
function changeVerify(){
  document.getElementById('verifyImg').src='/wxdemo/Admin/Login/verify';
}
function btn_login() {
    var u = $('#username').val();
    var p = $('#password').val();
    ...
    $.ajax({
        url: '/wxdemo/Admin/Login/dologin',
        type: "post",
        data: {
            'user': u,
            'password': p,
