...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('AdminUser/update');?>" method="post" id="form-admin-add">
		<input type="hidden" id="id" name="id" value="<?php echo ($detail["id"]); ?>"/>
		<input type="hidden" id="img_url" name="img_url" />
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($detail["name"]); ?>" placeholder="" id="adminName" name="adminName">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>初始密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off" value="<?php echo ($detail["name"]); ?>" placeholder="密码" id="password" name="password">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off" value="<?php echo ($detail["name"]); ?>"  placeholder="确认新密码" id="password2" name="password2">
		</div>
	</div>
	<div class="row cl">
		...
		<div class="form-group" style="height: 200px;text-align:center;">
			<img id="img" src="/wxdemo/Uploads<?php echo ($detail["img"]); ?>" width="130" height="130" border="0" />
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($detail["phone"]); ?>" placeholder="" id="phone" name="phone">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="@" value="<?php echo ($detail["email"]); ?>" name="email" id="email">
		</div>
	</div>
	<div class="row cl">
