...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('VoReply/update');?>" method="post" id="form-admin-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>语音</label>
			<div class="form-group" style="height: 200px;text-align:center;">
				<img id="img" src="/wxdemo/Public/admin/upload/images/voice.jpg" width="130" height="130" border="0" />
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($detail["voice_name"]); ?>" placeholder="" id="voice_name" name="voice_name">
			</div>
		</div>
		<div class="row cl">
