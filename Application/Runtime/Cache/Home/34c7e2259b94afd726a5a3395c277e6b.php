...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 图文 <span class="c-gray en">&gt;</span> 图文列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form action="<?php echo U('GrReply/index');?>" method="get" class="form form-horizontal" id="form-member-add">
<div class="page-container">
	<input type="text" name="code" id="code" placeholder=" 标题名称" value="<?php echo ($map["name"]); ?>" style="width:250px" class="input-text">
		<button class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜标题</button>
	</div>
</form>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picture_add('添加图文','/wxdemo/GrReply/add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加图文</a></span> <span class="r"><?php echo ($page); ?></span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td><img src="/wxdemo/Uploads<?php echo ($vo["picurl"]); ?>" height="20" width="50" /></td>
					<td ><?php echo ($vo["creat_time"]); ?></td>
					<td class="td-manage"><a style="text-decoration:none" class="ml-4" onClick="picture_edit('添加','/wxdemo/Home/GrReply/add','<?php echo ($vo["id"]); ?>')" href="javascript:;" title="添加"><i class="Hui-iconfont">&#xe604;</i></a>
						<a style="text-decoration:none" class="ml-5" onClick="picture_edit('文本编辑','/wxdemo/Home/GrReply/show','<?php echo ($vo["id"]); ?>')" href="javascript:;" title="查看"><i class="Hui-iconfont">&#xe6df;</i></a>
