...
<div class="page-container">
	<form class="form form-horizontal" action="<?php echo U('KeyReply/update');?>" method="post"  name="form1">
		<input type="hidden" class="input-text" value="<?php echo ($detail["id"]); ?>" placeholder="" id="id" name="id">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>关键字名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($detail["key_name"]); ?>" placeholder="" id="key_name" name="key_name">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="province" id="province" onChange="getCity()">
					<OPTION VALUE="<?php echo ($dcate["code"]); ?>"><?php echo ($dcate["name"]); ?> </OPTION>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="city">
					<OPTION VALUE="<?php echo ($xcate["id"]); ?>"><?php echo ($xcate["name"]); ?></OPTION>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
