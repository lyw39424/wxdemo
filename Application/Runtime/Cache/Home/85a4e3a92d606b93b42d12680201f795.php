...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('GrReply/update');?>" method="post" id="form-admin-add">
		<input type="hidden" id="picurl" name="picurl" value="<?php echo ($detail["picurl"]); ?>"/>
	...
	<div class="row cl">
			...
			<div class="form-group" style="height: 200px;text-align:center;">
				<img id="img" src="/wxdemo/Uploads<?php echo ($detail["picurl"]); ?>" width="130" height="130" border="0" />
	...
	<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($detail["autor"]); ?>" placeholder="" id="autor" name="autor">
			</div>
		</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>原文链接：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo ($detail["url"]); ?>"  id="url" name="url">
		</div>
	</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="discription" id="content" style="width:1000px;height:240px;" >
					<?php echo ($detail["discription"]); ?>
				</textarea>
				<script type="text/javascript">
