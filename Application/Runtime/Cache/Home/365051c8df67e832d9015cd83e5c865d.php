...
<form action="<?php echo U('WxUser/index');?>" method="get" class="form form-horizontal" id="form-member-add">
<div class="page-container">
	<input type="text" name="code" id="code" placeholder=" 标题名称" value="<?php echo ($map["bickname"]); ?>" style="width:250px" class="input-text">
