...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('MuReply/add');?>" method="post" id="form-admin-add">
	...
	<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  id="hq_music" name="hq_music">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>音乐描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="description"  style="width:1000px;height:240px;" ></textarea>
			</div>
        </div>
	<div class="row cl">
