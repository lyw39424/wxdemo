...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('VoReply/add');?>" method="post" id="form-admin-add">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="voice_name" name="voice_name">
		</div>
	</div>
	<div class="row cl">
