...
<div class="page-container">
	<form class="form form-horizontal" action="<?php echo U('TeReply/update');?>" method="post"  id="form-article-add">
		<input type="hidden" class="input-text"  id="id" name="id" value="<?php echo ($detail["id"]); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文本标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($detail["name"]); ?>" placeholder="" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文本内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="count" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"><?php echo ($detail["count"]); ?></textarea>
